...
function women(pName, price, category) {
...
function submitOrder(e) {
  ...
  alert(`Congratulation.you order is successful\n\n product: ${currentProduct}\nsize: ${size}\nAmount : ${qty}\nTolal price: ৳${totalPrice}`);
